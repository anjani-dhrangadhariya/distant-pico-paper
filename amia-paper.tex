...
LM outputs probabilistic labels for the training set were used as weak supervision signals to train the PubMedBERT that was trained to minimize noise-aware cross-entropy loss. % Anjani: Noise-aware loss functions
%
\begin{equation}
...
PubMedBERT was trained on fixed parameters listed in the supplementary material. 
