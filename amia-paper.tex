...
The intervention span can include information about name, role (main intervention or control) dosage, frequency and mode of administration.
...
Our task was to design $m$ weak labellers also called as labelling functions $\lambda^{m}$ corresponding to this fine-grained information, efficiently aggregate them to get probabilistic class labels, and use the weakly-labelled dataset for downstream PICO recognition tasks.
