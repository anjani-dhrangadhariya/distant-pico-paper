...
Multi-class fine-grained annotations were binarized i.e. a token label was set to 1 if the token represented an entity otherwise it was set to 0.
%
%
%
\begin{table}[h!]
...
We divided the experiments based on this level of information.
First set of experiments was done using only cheaper UMLS vocabularies.
...
\begin{table}[!ht]
    ...
    \begin{tabular}{|l|l|l|l|l|l|l|l|}
        ...
        ~ & +Ontology & 59.53 & 62.47 & running & running & ~ & ~ \\ 
