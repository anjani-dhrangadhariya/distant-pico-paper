...
The effectiveness of combining several weak labelling sources for more straightforward classes like disease, chemicals, drugs and disorders has been explored by Fries et al.
...
Nonetheless, PICO categories are intricate in that they can be subdivided into subclasses.
...
Similarly, tier two for participants performs well only if ontologies are added for the participant subclasses like age and gender not limited to diseases or disorders.
