...
weakly-supervised PubMedBERT did not always improve the performance compared to its label model counterpart, but led to the best F1 score for each target class.
...
%==============================
%
We demonstrate the effectiveness of weak supervision for a complicated PICO recognition task using medical and non-medical ontologies and expert-generated rules.
