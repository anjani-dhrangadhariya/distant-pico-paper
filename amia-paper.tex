...
Explain about the UMLS ranking and partition as inspired from Trove. 
...
To further check the performance contribution from the high-cost expert-generated rules, we added a third arm with all the ReGeX, heuristics and distant supervision classifiers.
...
The probabilistic labels obtained from the trained label model were used as noisy labels for the downstream deep neural networks.
We used a PubMedBERT with a linear layer and the noise-aware loss function as the downstream model for PICOS recognition.
%
%
%
%==============================
