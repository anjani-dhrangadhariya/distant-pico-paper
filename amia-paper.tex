...
Error correction leads to better F1 performance for all the targets, especially for the participant class where both the LM and the weakly supervised F1 overtake the full-supervision score by x\% - xx\% . 
