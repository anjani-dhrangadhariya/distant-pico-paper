...
%==============================
%
Our study demonstrates the feasibility and prowess of using weak supervision for PICO entity extraction.
...
In another study, we use weak supervision to successfully extend PICO to PICOS extraction (S = Study type) without needing additional annotated ``Study type'' data to quickly power applications.\cite{dhrangadhariya2023picos}
...
A decreased or stagnant F1 shows this after adding non-UMLS LFs to the UMLS tier.
