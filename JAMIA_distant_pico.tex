...
The process can be automated using machine learning (ML) by directly pointing the human reviewers to the correct text chunks describing PICO thereby facilitating quick decision-making whether the study is relevant or not.
