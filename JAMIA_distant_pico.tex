...
%==============================
%
\subsection{PICO subclasses}
%
We extended the EBM-PICO subclasses (refer to Table~\ref{tab:coarsefineconcept}) to better query the labelling sources and design LFs (see Figure~\ref{fig:target_subgroups}).
...
The distant supervision CTO and the hand-crafted dictionaries are available on Zenodo (DOI: 10.5281/zenodo.7320235). 
